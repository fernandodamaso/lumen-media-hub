...
@Component({
  ...
  `,
  styles: `:host { display: block; } .header-tools { display:flex; align-items:center; gap:14px; flex-wrap:wrap; } .speed { display:grid; gap:3px; font-variant-numeric:tabular-nums; } .speed span { color:var(--mm-component-text-muted); font-size:12px; font-weight:700; text-transform:uppercase; } .speed strong { color:var(--mm-component-text-primary); font-size:15px; } h2 { margin: 0; color: var(--mm-component-text-primary); font-size: 24px; } .section-copy { margin-top: 6px; color: var(--mm-component-text-secondary); font-size: 14px; } .actions { display: flex; flex-wrap: wrap; gap: 10px; } .notice { margin: 0 0 14px; } .summary { display: grid; grid-template-columns: repeat(2, 1fr); gap: 1px; margin-bottom: 14px; overflow: hidden; border: 1px solid var(--mm-component-border); border-radius: var(--mm-radius-md); background: var(--mm-component-border); } .summary div { display: grid; gap: 5px; padding: 16px; background: var(--mm-component-card-bg); } .summary strong { color: var(--mm-component-text-primary); font-size: 18px; font-variant-numeric:tabular-nums; } .summary span, .category, .torrent-meta { color: var(--mm-component-text-muted); font-size: 12px; } .torrent-list { display: grid; gap: 10px; } .torrent { display: grid; gap: 14px; padding: 18px; border: 1px solid var(--mm-component-border); border-radius: var(--mm-radius-md); background: var(--mm-component-card-bg); } .torrent-head, .torrent-meta { display: flex; align-items: center; justify-content: space-between; gap: 14px; flex-wrap: wrap; } h3 { margin: 0 0 4px; color: var(--mm-component-text-primary); font-size: 15px; } .progress-row { display: flex; } .torrent-meta { justify-content: flex-start; gap: 24px; font-variant-numeric:tabular-nums; } @container (max-width: 560px) { .header-tools { align-items: start; } .torrent-meta { gap: 12px; } }`,
})
